  ...
  return (
    <Sidebar collapsible="icon" variant="sidebar" className="border-r">
      <SidebarHeader className="px-4 py-3">
        <div className="flex items-center gap-3 group-data-[collapsible=icon]:flex-col group-data-[collapsible=icon]:gap-1 group-data-[collapsible=icon]:items-center">
          <div className="flex items-center gap-2 group-data-[collapsible=icon]:gap-1">
            <img src="/lovable-uploads/389916be-930f-42dc-b755-a2f4c9100e79.png" alt="3echo logo" className="h-6 w-6 object-contain flex-shrink-0" loading="lazy" />
            <span aria-hidden className="text-muted-foreground group-data-[collapsible=icon]:hidden">×</span>
            <img src="/lovable-uploads/b6db8393-9c7c-4de1-b65c-5aebf510b1ec.png" alt="BSL logo" className="h-6 w-6 object-contain rounded-sm flex-shrink-0" loading="lazy" />
          </div>
